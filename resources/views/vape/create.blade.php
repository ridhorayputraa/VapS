    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                ...
                @endif
                <form class="w-full" action="{{ route('vape.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            {{-- Biar admin yang masukin sesuai format --}}
                            {{-- Fe nya butuh 3 ini  --}}
                            <p class="text-gray-600 text-xs italic">Dipisahkan dengan koma, contoh: Recommended, Popular, New_Vape</p>
                        </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                        <div class="w-full px-3">
